...
export const DAILY_QUESTS: Quest[] = [
  ...
  },
  {
    ...
    instructions: "Enregistre tes heures de sommeil (minimum 7h) dans la section Sommeil ou via Apple Health.",
    icon: '😴',
    xp: 15,
    period: 'daily',
    target: 7,
  ...
  },
  {
    ...
    instructions: "Marche 8000 pas minimum. Synchro automatique via Apple Health ou Google Fit.",
    icon: '👟',
    xp: 25,
    period: 'daily',
    target: 8000,
...
export const MONTHLY_QUESTS: Quest[] = [
  ...
  },
  {
    ...
    instructions: "Dors 7h+ pendant 20 nuits ce mois. Enregistre ton sommeil via Apple Health ou manuellement.",
    icon: '🌙',
    xp: 350,
    period: 'monthly',
    target: 20,
