...
export const DAILY_QUESTS: Quest[] = [
  ...
  },
  {
    id: 'daily_breakfast',
    title: 'Petit-Dej',
    description: 'Bien manger le matin',
    icon: '🍳',
    xp: 10,
    period: 'daily',
    target: 1,
  ...
  },
  {
    id: 'daily_meditation',
    title: 'Spirituel',
    description: 'Meditation ou priere',
    icon: '🙏',
    xp: 15,
    period: 'daily',
    target: 1,
  ...
  },
  {
    id: 'daily_protein',
    title: 'Proteine',
    description: 'Manger tes proteines',
    icon: '🥩',
    xp: 20,
    period: 'daily',
    target: 1,
...
export const WEEKLY_QUESTS: Quest[] = [
  ...
  },
  {
    id: 'weekly_rest_day',
    title: 'Repos',
    description: 'Jour de recuperation',
    icon: '🛋️',
    xp: 50,
    period: 'weekly',
    target: 1,
  ...
  },
  {
    id: 'weekly_try_new',
    title: 'Decouverte',
    description: 'Essayer un nouvel exo',
    icon: '🆕',
    xp: 60,
    period: 'weekly',
    target: 1,
  },
  {
    id: 'weekly_photo',
    title: 'Photo Hebdo',
    description: 'Photo de la semaine',
    icon: '📸',
    xp: 75,
    period: 'weekly',
    target: 1,
  },
  {
    id: 'weekly_meal_prep',
    title: 'Preparation',
    description: 'Preparer tes repas',
    icon: '🍱',
    xp: 80,
    period: 'weekly',
    target: 1,
  ...
  },
  {
    ...
    title: 'Mensurations',
    description: 'Prendre tes mesures',
    icon: '📏',
    xp: 100,
    period: 'weekly',
    target: 1,
  },
  {
    id: 'weekly_no_sugar',
    title: 'Sans Sucre',
    description: '3 jours sans sucre',
    icon: '🍭',
    xp: 110,
    period: 'weekly',
    target: 3,
...
export const MONTHLY_QUESTS: Quest[] = [
  ...
  },
  {
    ...
    title: 'Bilan Complet',
    description: '4 bilans corporels',
    icon: '📊',
    xp: 300,
    period: 'monthly',
    target: 4,
  ...
  },
  {
    ...
    title: 'Hydratation Max',
    description: '25 jours hydrate',
    icon: '💧',
    xp: 400,
    period: 'monthly',
    target: 25,
  ...
  },
  {
    ...
    title: 'Parfait',
    description: '10 jours tous defis OK',
    icon: '💯',
    xp: 500,
    period: 'monthly',
    target: 10,
  ...
  },
  {
    ...
    title: '30 Jours',
    description: '30j sans interruption',
    icon: '🔥',
    xp: 600,
    period: 'monthly',
    target: 30,
  ...
  },
  {
    ...
    description: 'Atteindre ton objectif',
    icon: '👑',
    xp: 700,
    period: 'monthly',
    target: 1,
