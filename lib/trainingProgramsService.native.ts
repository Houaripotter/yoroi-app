...
export const initProgramsTables = () => {
  try {
    ...
    logger.info('[PROGRAMS] Tables initialisées avec succès');
  } catch (error) {
...
export const createProgram = (
  ...
  try {
    ...
    logger.info('[PROGRAMS] Programme créé:', result.lastInsertRowId);
...
export const updateProgram = (
  ...
  try {
    ...
    logger.info('[PROGRAMS] Programme mis à jour:', id);
  } catch (error) {
...
export const deleteProgram = (id: number): void => {
  try {
    ...
    logger.info('[PROGRAMS] Programme supprimé:', id);
  } catch (error) {
...
export const addItemToProgram = (programId: number, itemId: number): void => {
  try {
    ...
    logger.info('[PROGRAMS] Objectif ajouté au programme:', { programId, itemId, nextOrder });
  } catch (error) {
...
export const removeItemFromProgram = (programId: number, itemId: number): void => {
  try {
    ...
    logger.info('[PROGRAMS] Objectif retiré du programme:', { programId, itemId });
  } catch (error) {
...
export const reorderProgramItems = (programId: number, itemOrders: { itemId: number; order: number }[]): void => {
  try {
    ...
    logger.info('[PROGRAMS] Ordre des objectifs mis à jour');
  } catch (error) {
