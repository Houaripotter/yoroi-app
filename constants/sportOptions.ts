...
export const SPORT_OPTIONS: Record<string, SportOption[]> = {
  ...
  musculation: [
    // PECTORAUX
    { id: 'm_c_be', label: 'Développé Couché (Barre)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_be_h', label: 'Développé Couché (Haltères)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_in', label: 'Développé Incliné (Barre)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_in_h', label: 'Développé Incliné (Haltères)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_dec', label: 'Développé Décliné (Barre)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_dec_h', label: 'Développé Décliné (Haltères)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_fl', label: 'Écartés (Haltères)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_fl_ph', label: 'Écartés Poulie Haute', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_fl_pb', label: 'Écartés Poulie Basse', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_pec', label: 'Pec Deck (Butterfly)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_chest_m', label: 'Chest Press (Machine)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_dip', label: 'Dips (Pectoraux)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_pump', label: 'Pompes', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_pump_dec', label: 'Pompes Déclinées', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_pump_dia', label: 'Pompes Diamant', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_cable', label: 'Cable Cross-over', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_pullover', label: 'Pull Over (Haltère)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_land', label: 'Landmine Press', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    { id: 'm_c_floor', label: 'Floor Press (Haltères)', icon: 'arm-flex', color: '#EF4444', group: 'PECTORAUX' },
    // DOS
    { id: 'm_b_pu', label: 'Tractions (Pronation)', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_pu_sup', label: 'Tractions (Supination)', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_pu_neu', label: 'Tractions Neutres', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_pu_lar', label: 'Tractions Larges', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_pd', label: 'Tirage Vertical (Lat Pulldown)', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_pd_nq', label: 'Tirage Nuque', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_pd_vb', label: 'Tirage Serré (V-Bar)', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_ro', label: 'Rowing Barre (Bent Over)', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_ro_h', label: 'Rowing Haltère (One Arm)', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_tbar', label: 'T-Bar Row', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_pendlay', label: 'Rowing Pendlay', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_hr', label: 'Tirage Horizontal (Seated Row)', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_hr_uni', label: 'Tirage Horizontal Unilatéral', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_dl', label: 'Soulevé de Terre', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_dl_rom', label: 'Deadlift Roumain', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_dl_sumo', label: 'Deadlift Sumo', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_pullover_ph', label: 'Pull Over Poulie Haute', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_lom', label: 'Banc à Lombaires', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_hyper', label: 'Hyperextensions', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_gm', label: 'Good Morning', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_seal', label: 'Seal Row', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_meadows', label: 'Meadows Row', icon: 'human', color: '#3B82F6', group: 'DOS' },
    { id: 'm_b_fp', label: 'Face Pull', icon: 'human', color: '#3B82F6', group: 'DOS' },
    // ÉPAULES
    { id: 'm_s_pr', label: 'Développé Militaire (Barre)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_pr_as', label: 'Développé Militaire Assis', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_pr_h', label: 'Développé Haltères Assis', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_pr_hd', label: 'Développé Haltères Debout', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_arnold', label: 'Arnold Press', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_pushpr', label: 'Push Press', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_la', label: 'Élévations Latérales (Haltères)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_la_p', label: 'Élévations Latérales (Poulie)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_la_m', label: 'Élévations Latérales (Machine)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_fr', label: 'Élévations Frontales (Haltères)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_fr_b', label: 'Élévations Frontales (Barre)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_oi', label: 'Oiseau (Rear Delts)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_oi_m', label: 'Oiseau Machine (Reverse Pec)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_sh', label: 'Shrugs (Trapèzes)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_fp', label: 'Face Pull', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_lu', label: 'Lu Raises', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    { id: 'm_s_upr', label: 'Tirage Menton (Upright Row)', icon: 'triangle', color: '#F59E0B', group: 'ÉPAULES' },
    // BICEPS
    { id: 'm_bi_ez', label: 'Curl Barre EZ', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_dr', label: 'Curl Barre Droite', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_alt', label: 'Curl Haltères Alterné', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_sim', label: 'Curl Haltères Simultané', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_a_hammer', label: 'Curl Marteau (Hammer)', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_a_preacher', label: 'Preacher Curl (Pupitre)', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_incl', label: 'Curl Incliné (Haltères)', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_conc', label: 'Curl Concentré', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_pb', label: 'Curl Poulie Basse', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_spider', label: 'Curl Spider (Poulie Haute)', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_mach', label: 'Curl Machine', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_21', label: 'Curl 21s', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_drag', label: 'Drag Curl', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_zott', label: 'Curl Zottman', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    { id: 'm_bi_rev', label: 'Reverse Curl (Avant-bras)', icon: 'arm-flex', color: '#8B5CF6', group: 'BICEPS' },
    // TRICEPS
    { id: 'm_tr_pc', label: 'Pushdown Corde', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_pb', label: 'Pushdown Barre', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_vb', label: 'Pushdown V-Bar', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_skull', label: 'Skullcrusher (Barre)', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_skull_h', label: 'Skullcrusher (Haltères)', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_a_tr', label: 'Dips (Triceps)', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_dips_b', label: 'Dips Banc', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_a_extnuque', label: 'Extension Nuque (1 main)', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_ext2', label: 'Extension Nuque (2 mains)', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_kick', label: 'Kickback (Haltère)', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_kick_p', label: 'Kickback (Poulie)', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_cgbp', label: 'Close Grip Bench Press', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_jm', label: 'JM Press', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_mach', label: 'Triceps Machine', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_diam', label: 'Diamond Push-ups', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    { id: 'm_tr_oh', label: 'Overhead Extension Poulie', icon: 'arm-flex-outline', color: '#7C3AED', group: 'TRICEPS' },
    // AVANT-BRAS
    { id: 'm_a_av', label: 'Curl Poignets (Flexion)', icon: 'arm-flex', color: '#6366F1', group: 'AVANT-BRAS' },
    { id: 'm_av_ext', label: 'Extension Poignets', icon: 'arm-flex', color: '#6366F1', group: 'AVANT-BRAS' },
    { id: 'm_av_farmer', label: 'Farmer Walk', icon: 'walk', color: '#6366F1', group: 'AVANT-BRAS' },
    { id: 'm_av_hang', label: 'Dead Hang', icon: 'human', color: '#6366F1', group: 'AVANT-BRAS' },
    { id: 'm_av_grip', label: 'Gripper / Hand Grip', icon: 'hand-grip', color: '#6366F1', group: 'AVANT-BRAS' },
    { id: 'm_av_wrist', label: 'Wrist Roller', icon: 'arm-flex', color: '#6366F1', group: 'AVANT-BRAS' },
    // QUADRICEPS
    { id: 'm_l_sq', label: 'Squat Barre Libre', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_sq_h', label: 'Squat Barre Haute', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_sq_b', label: 'Squat Barre Basse', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_fsq', label: 'Front Squat', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_gsq', label: 'Goblet Squat', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_bulg', label: 'Squat Bulgare', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_sissy', label: 'Squat Sissy', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_zq', label: 'Squat Zercher', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_pr', label: 'Presse à Cuisses', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_pr_uni', label: 'Presse Unilatérale', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_le', label: 'Leg Extension', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_hack', label: 'Hack Squat', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_hack_inv', label: 'Hack Squat Inversé', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_pend', label: 'Pendulum Squat', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_smith', label: 'Smith Machine Squat', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_lu', label: 'Fentes Avant (Haltères)', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_lu_ar', label: 'Fentes Arrière', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_lu_ma', label: 'Fentes Marchées', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_stepup', label: 'Step Up (Haltères)', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_boxsq', label: 'Box Squat', icon: 'human-male', color: '#06B6D4', group: 'QUADRICEPS' },
    { id: 'm_l_box', label: 'Box Jump', icon: 'arrow-up-bold', color: '#06B6D4', group: 'QUADRICEPS' },
    // ISCHIOS-JAMBIERS
    { id: 'm_is_lcc', label: 'Leg Curl Couché', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    { id: 'm_is_lca', label: 'Leg Curl Assis', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    { id: 'm_is_lcd', label: 'Leg Curl Debout', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    { id: 'm_l_lc', label: 'SDT Jambes Tendues', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    { id: 'm_l_rdl', label: 'Romanian Deadlift (Haltères)', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    { id: 'm_is_sldl', label: 'Single Leg Deadlift', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    { id: 'm_is_nordic', label: 'Nordic Curl', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    { id: 'm_is_ghr', label: 'Glute Ham Raise', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    { id: 'm_is_slider', label: 'Slider Leg Curl', icon: 'human-male', color: '#0284C7', group: 'ISCHIOS' },
    // FESSIERS
    { id: 'm_l_ht', label: 'Hip Thrust (Barre)', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_ht_m', label: 'Hip Thrust Machine', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_ht_sl', label: 'Single Leg Hip Thrust', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_gb', label: 'Glute Bridge', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_l_add', label: 'Adducteurs Machine', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_l_abd', label: 'Abducteurs Machine', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_kb', label: 'Kick-back Poulie', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_dk', label: 'Donkey Kicks', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_fh', label: 'Fire Hydrants', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_clam', label: 'Clamshells', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_cpt', label: 'Cable Pull Through', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_bw', label: 'Banded Walks', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_rev', label: 'Reverse Lunges', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    { id: 'm_fe_curtsy', label: 'Curtsy Lunges', icon: 'human-male', color: '#EC4899', group: 'FESSIERS' },
    // MOLLETS
    { id: 'm_l_mo', label: 'Mollets Debout (Machine)', icon: 'human-male', color: '#14B8A6', group: 'MOLLETS' },
    { id: 'm_mo_as', label: 'Mollets Assis (Machine)', icon: 'human-male', color: '#14B8A6', group: 'MOLLETS' },
    { id: 'm_mo_pr', label: 'Mollets à la Presse', icon: 'human-male', color: '#14B8A6', group: 'MOLLETS' },
    { id: 'm_mo_h', label: 'Mollets Haltères (Debout)', icon: 'human-male', color: '#14B8A6', group: 'MOLLETS' },
    { id: 'm_mo_uni', label: 'Mollets Unilatéral', icon: 'human-male', color: '#14B8A6', group: 'MOLLETS' },
    { id: 'm_mo_don', label: 'Donkey Calf Raise', icon: 'human-male', color: '#14B8A6', group: 'MOLLETS' },
    { id: 'm_mo_tib', label: 'Tibialis Raise', icon: 'human-male', color: '#14B8A6', group: 'MOLLETS' },
    // ABDOMINAUX
    { id: 'm_abs_c', label: 'Crunch Abdominal', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_ci', label: 'Crunch Inversé', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_cable', label: 'Crunch Poulie Haute', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_mach', label: 'Crunch Machine', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_r', label: 'Relevé de Jambes Suspendu', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_rb', label: 'Relevé de Jambes (Banc)', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_rs', label: 'Relevé de Jambes (Sol)', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_p', label: 'Gainage Planche', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_pl', label: 'Gainage Latéral', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_t', label: 'Russian Twist', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_tl', label: 'Russian Twist (Lesté)', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_w', label: 'Roulette Abdos (Abs Wheel)', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_su', label: 'Sit-ups', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_vu', label: 'V-ups', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_bc', label: 'Bicycle Crunches', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_mc', label: 'Mountain Climbers', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_dead', label: 'Dead Bug', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_bd', label: 'Bird Dog', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_hollow', label: 'Hollow Hold', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_lsit', label: 'L-Sit', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_ttb', label: 'Toes to Bar', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_ww', label: 'Windshield Wipers', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_df', label: 'Dragon Flag', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_pallof', label: 'Pallof Press', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    { id: 'm_abs_wc', label: 'Woodchop Poulie', icon: 'view-grid', color: '#84CC16', group: 'ABDOMINAUX' },
    // COMPOUND / HALTÉROPHILIE
    ...
    { id: 'm_cp_snatch', label: 'Snatch', icon: 'weight-lifter', color: '#DC2626', group: 'COMPOUND' },
    { id: 'm_cp_clean', label: 'Clean (Épaulé)', icon: 'weight-lifter', color: '#DC2626', group: 'COMPOUND' },
    { id: 'm_cp_jerk', label: 'Jerk (Jeté)', icon: 'weight-lifter', color: '#DC2626', group: 'COMPOUND' },
    { id: 'm_cp_fsq', label: 'Front Squat Olym.', icon: 'weight-lifter', color: '#DC2626', group: 'COMPOUND' },
    // KETTLEBELL
    ...
    { id: 'm_ket_gob', label: 'Goblet Squat KB', icon: 'kettlebell', color: '#F59E0B', group: 'KETTLEBELL' },
    { id: 'm_ket_dl', label: 'KB Deadlift', icon: 'kettlebell', color: '#F59E0B', group: 'KETTLEBELL' },
    { id: 'm_ket_row', label: 'KB Row', icon: 'kettlebell', color: '#F59E0B', group: 'KETTLEBELL' },
    // CARDIO
    ...
    { id: 'm_car_ab', label: 'Assault Bike', icon: 'bike', color: '#10B981', group: 'CARDIO' },
    { id: 'm_car_corde', label: 'Corde à sauter', icon: 'jump-rope', color: '#10B981', group: 'CARDIO' },
  ],
