...
// Mapping entre les IDs internes et les noms d'icones dans app.json
...
export default function LogosScreen() {
  ...
  const handleLogoChange = async (logoId: string) => {
    try {
      ...
      // Changer l'icone native de l'app (uniquement en build natif)
      ...
      Alert.alert('Erreur', 'Impossible de changer le logo. Relance l\'app et reessaie.');
    }
  };
