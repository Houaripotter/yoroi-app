...
const BRAND_CONFIGS: BrandConfig[] = [
  {
    ...
    introIOS: "Withings ne se connecte pas directement à YOROI. Ta balance ou montre Withings synchronise ses données dans Apple Santé via Health Mate, et YOROI les lit depuis Apple Santé. Apple Santé est le pont entre les deux.",
    introAndroid: "Withings ne se connecte pas directement à YOROI. Ta balance ou montre Withings synchronise ses données dans Health Connect via Health Mate, et YOROI les lit depuis Health Connect. Health Connect est le pont entre les deux.",
    stepsIOS: [
      "Ouvre l'app Health Mate sur ton iPhone",
      'Va dans Profil (icône en bas à droite) → Santé → Apple Santé',
      'Active toutes les catégories disponibles',
      'Synchronise ton appareil Withings (reste dans l\'app quelques minutes)',
      'Reviens dans YOROI → Actualiser les données',
    ],
    stepsAndroid: [
      "Ouvre l'app Health Mate sur ton téléphone",
      'Va dans Profil → Santé → Health Connect',
      'Donne l\'accès à toutes les catégories',
      'Synchronise ton appareil Withings (reste dans l\'app quelques minutes)',
      'Reviens dans YOROI → Actualiser les données',
    ],
  },
  {
    ...
    introIOS: "Garmin ne se connecte pas directement à YOROI. Ta montre Garmin synchronise ses données dans Apple Santé, et YOROI les lit depuis Apple Santé. Apple Santé est le pont entre les deux.",
    introAndroid: "Garmin ne se connecte pas directement à YOROI. Ta montre Garmin synchronise ses données dans Health Connect, et YOROI les lit depuis Health Connect. Health Connect est le pont entre les deux.",
    stepsIOS: [
      "Ouvre l'app Garmin Connect sur ton iPhone",
      'Va dans Profil (icône en bas à droite) → Santé → Apple Santé',
      'Active toutes les catégories disponibles',
      'Synchronise ta Garmin, attends quelques minutes',
      'Reviens dans YOROI → Actualiser les données',
    ],
    stepsAndroid: [
      "Ouvre l'app Garmin Connect sur ton téléphone",
      'Va dans Plus → Paramètres → Health Connect',
      'Donne l\'accès à toutes les catégories',
      'Synchronise ta Garmin (reste dans l\'app quelques minutes)',
      'Reviens dans YOROI → Actualiser les données',
    ],
  },
  {
    ...
    introIOS: "Polar ne se connecte pas directement à YOROI. Ta montre Polar synchronise ses données dans Apple Santé via Polar Flow, et YOROI les lit depuis Apple Santé. Apple Santé est le pont entre les deux.",
    introAndroid: "Polar ne se connecte pas directement à YOROI. Ta montre Polar synchronise ses données dans Health Connect via Polar Flow, et YOROI les lit depuis Health Connect. Health Connect est le pont entre les deux.",
    stepsIOS: [
      "Ouvre l'app Polar Flow sur ton iPhone",
      'Va dans Profil → Paramètres → Apple Santé',
      'Active le partage de toutes les catégories disponibles',
      'Synchronise ta montre Polar (ouvre Polar Flow, attends la sync)',
      'Reviens dans YOROI → Actualiser les données',
    ],
    stepsAndroid: [
      "Ouvre l'app Polar Flow sur ton téléphone",
      'Va dans Profil → Paramètres → Health Connect',
      'Donne l\'accès à toutes les catégories',
      'Synchronise ta montre Polar (reste dans l\'app quelques minutes)',
      'Reviens dans YOROI → Actualiser les données',
    ],
  },
  {
    ...
    introIOS: "WHOOP ne se connecte pas directement à YOROI. Ton bracelet WHOOP synchronise ses données dans Apple Santé, et YOROI les lit depuis Apple Santé. Apple Santé est le pont entre les deux.",
    introAndroid: "WHOOP ne se connecte pas directement à YOROI. Ton bracelet WHOOP synchronise ses données dans Health Connect, et YOROI les lit depuis Health Connect. Health Connect est le pont entre les deux.",
    stepsIOS: [
      "Ouvre l'app WHOOP sur ton iPhone",
      'Va dans Profil (icône en haut à gauche) → Apps & Appareils → Apple Santé',
      'Active toutes les catégories disponibles',
      'Laisse WHOOP se synchroniser (garde l\'app ouverte quelques minutes)',
      'Reviens dans YOROI → Actualiser les données',
    ],
    stepsAndroid: [
      "Ouvre l'app WHOOP sur ton téléphone",
      'Va dans Profil → Apps & Appareils → Health Connect',
      'Donne l\'accès à toutes les catégories',
      'Laisse WHOOP se synchroniser (garde l\'app ouverte quelques minutes)',
      'Reviens dans YOROI → Actualiser les données',
    ],
  },
  {
    ...
    introIOS: "Fitbit ne se connecte pas directement à YOROI. Ton bracelet Fitbit synchronise ses données dans Apple Santé, et YOROI les lit depuis Apple Santé. Apple Santé est le pont entre les deux.",
    introAndroid: "Fitbit ne se connecte pas directement à YOROI. Ton bracelet Fitbit synchronise ses données dans Health Connect, et YOROI les lit depuis Health Connect. Health Connect est le pont entre les deux.",
    stepsIOS: [
      "Ouvre l'app Fitbit sur ton iPhone",
      'Va dans Compte (icône en bas à droite) → Avancé → Apple Santé',
      'Active toutes les catégories de données',
      'Synchronise ton Fitbit (reste dans l\'app quelques minutes)',
      'Reviens dans YOROI → Actualiser les données',
    ],
    stepsAndroid: [
      "Ouvre l'app Fitbit sur ton téléphone",
      'Va dans Compte → Avancé → Health Connect',
      'Donne l\'accès à toutes les catégories de données',
      'Synchronise ton Fitbit (reste dans l\'app quelques minutes)',
      'Reviens dans YOROI → Actualiser les données',
    ],
  },
  {
    key: 'scales',
    name: 'Balances connectées',
    color: '#8B5CF6',
    emoji: 'B',
    types: ['Poids', 'Graisse', 'Masse maigre', 'BMR'],
    introIOS: "Ta balance ne se connecte pas directement à YOROI. Elle synchronise ses données dans Apple Santé via son app (Xiaomi, Renpho, Eufy, Omron...), et YOROI les lit depuis Apple Santé. Apple Santé est le pont entre les deux.",
    introAndroid: "Ta balance ne se connecte pas directement à YOROI. Elle synchronise ses données dans Health Connect via son app (Xiaomi, Renpho, Eufy, Omron...), et YOROI les lit depuis Health Connect. Health Connect est le pont entre les deux.",
    stepsIOS: [
      "Ouvre l'app de ta balance (Xiaomi, Renpho, Eufy, Omron...)",
      'Va dans Réglages → Apple Santé (ou Santé)',
      'Active le partage du poids et de la composition corporelle',
      'Monte sur ta balance pour déclencher une mesure',
      'Reviens dans YOROI → Actualiser les données',
    ],
    stepsAndroid: [
      "Ouvre l'app de ta balance (Xiaomi, Renpho, Eufy, Omron...)",
      'Va dans Réglages → Health Connect',
      'Donne l\'accès au poids et à la composition corporelle',
      'Monte sur ta balance pour déclencher une mesure',
      'Reviens dans YOROI → Actualiser les données',
    ],
  },
